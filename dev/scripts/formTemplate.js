...
var CheckboxGroupDropdown = require('./dropdown-checkboxGroupDropdown');
...
FormTemplate.prototype._initCustomElements = function() {
    ...
    var checkboxGroupDropdownElem = this._elem.querySelector('.checkbox_group_dropdown');
    if (checkboxGroupDropdownElem) {
        this._checkboxGroupDropdown = new CheckboxGroupDropdown({
            elem: checkboxGroupDropdownElem,
...
FormTemplate.prototype._getUserInputValues = function() {
    ...
    for (var i = 0; i < inputsArr.length; i++) {
        ...
        } else if (input.classList.contains('checkbox_group_dropdown')) {
            name =  input.getAttribute('name');
            value = escapeHTML(input.dataset.value);
...
/*FormTemplate.prototype._resetFields = function() {
...
/*FormTemplate.prototype._findInstanceByElem = function(elem, instanceArr) {
    if (elem && instanceArr) {
