...
//    console.log('this._currSlide = ' + this._currSlide);
//    console.log('this._slidesCount = ' + this._slidesCount);
//    console.log(this._currSlide > this._slidesCount);
